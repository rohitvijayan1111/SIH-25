  ...
  return (
    <View style={tw`bg-white p-4 rounded-lg border-gray-300 border-2 m-2`}>
      ...
      >
        ...
        >
          <Text style={tw`text-sm font-semibold`} className='text-[#2B9846]' onPress={() => navigation.navigate('ProcurementDetails')}>More Details</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={tw`flex-row justify-between mb-2`}>
        ...
        <Text style={tw`text-gray-500`} className="text-lg">Variety</Text>
      ...
      <TouchableOpacity
        ...
        className='bg-[#2B9846]'
      >
        <Text style={tw`text-white text-sm font-semibold justify-center items-center flex`}>Complete the form</Text>
      </TouchableOpacity>
    </View>
  );
}
