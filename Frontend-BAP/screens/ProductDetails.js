...
class ProductDetailsScreen extends StatefulWidget {
  ...
  const ProductDetailsScreen({Key? key, required this.itemId}) : super(key: key);
      ...
      if (json["bpp_response"]?["message"]?["catalog"] != null) {
        ...
        if ((mainItem["batches"] as List).isNotEmpty) {
          ...
          productInfo = {
            ...
            "weightPerUnit": firstBatch["quantity"]?["unitized"]?["measure"]?["weight_per_unit"],
